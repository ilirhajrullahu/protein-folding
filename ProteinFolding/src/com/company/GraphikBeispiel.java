...
// Beispiel zu Java 2D-Graphik f�r Genetische Algorithmen
...
public class GraphikBeispiel {
	...
	public static void main(String[] args) {
		...
		BufferedImage image = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB); //bufered image ist leinwand
		Graphics2D g2 = image.createGraphics(); // mal kasten
